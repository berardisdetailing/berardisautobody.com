...
public class SendEmailHandler : IHttpHandler
{
	...
	public void ProcessRequest(HttpContext context)
	{
		...
		using (SmtpClient smtp = new SmtpClient())
		{
			...
			message.From = new MailAddress(WebConfigurationManager.AppSettings["NoReplyEmail"], "Berardi's Auto Body No Reply");
			...
			message.Body += "sent-from:" + Environment.NewLine + "berardisautobody.com" + Environment.NewLine + Environment.NewLine;
